...
same_minute_guard_id = nil
top_minute = nil
highest_count = 0

minutes_asleep_counters.each do |guard_id, minutes|
  minutes.each do |minute, count|
    if count > highest_count
      same_minute_guard_id = guard_id
      top_minute = minute
      highest_count = count
    end
  end
...
puts same_minute_guard_id
puts top_minute
puts same_minute_guard_id.to_i * top_minute.to_i
